                    ...
                    <Space direction='vertical' style={{ minWidth: "22vh"}}>
                        <Row>
                            <Space direction='vertical'>
                                <Row>
                                    <Text style={{ ...typeStyles, fontSize:"1rem", fontWeight:"light"}} align="">Welcome back</Text>
                                </Row>
                                <Row>
                                    <Text style={{ ...typeStyles, fontSize:"2rem", lineHeight:"1rem", fontWeight:"700", paddingBottom:"1rem"}}>Login to your account</Text>
                                </Row>
                                    <Form
                                        layout={'vertical'}
                                        form={form}
                                        ...
                                        <Form.Item 
                                            ...
                                            style={{ ...formItemStyles, color: "white", marginBottom:"15px", padding:"0px", marginBottom:"5px"  }}
                                            >
                                        ...
                                        <Form.Item style={{ ...formItemStyles }}>
                                            <Button type="primary" style={{ ...buttonStyles, background: "#35AE9A" }}>Login Now</Button>
                                        </Form.Item>
                                        <Form.Item style={{ ...formItemStyles }}>
                            ...
                            <Col style={{ width:"100%"}}>
                                <Space style={{ width:"100%", justifyContent:"center" }}>
                                    <Text style={{ ...typeStyles, opacity:"0.8"}} >
                                        Don't have an account? <Link href="http://localhost:3000/register" style={{ color: "#35AE9A"}}>Join free today</Link>
                                    </Text>
                                </Space>
                            </Col>
                        </Row>
