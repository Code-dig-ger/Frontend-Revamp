    ...
    return (
        <div>
            <div className="topic-section">
                <img src="https://i.pinimg.com/736x/9a/0c/96/9a0c965fa8513084eac34d22791d67c8.jpg" className="page_logo"></img>
                <h3 className='topic_name'>TOPIC1</h3>
                <div className="topic_content">
                    <p>In mathematics and computer science, an algorithm is 
                    defined as a process or set of rules to be followed in
						...
						return (
							<div className="question-map" key={i}>
                                ...
                                <img src='https://i.pinimg.com/736x/9a/0c/96/9a0c965fa8513084eac34d22791d67c8.jpg' 
									...
									<a href={question.url}>
                                    <Button type shape='round' size='large' style={{ position:"absolute" , right:"40px" , background:"#1890ff"}}>
                                        Play
                                    </Button>
									</a>
                                    <div>
                                        <span><b>Platform:</b> {question.platform}</span>
                                        <span style={{color:"white"}}>-</span>
                                        <span><b>Rating:</b> {question.rating}</span>
                                        <span style={{color:"white"}}>-</span>
            ...
            <div className='companions-list'>
                ...
                <div className='companions_number'>
                    <p style={{ position: "absolute", left: "85px", fontSize: "20px", color: "grey" }}><b>Companions</b></p>
                    <p style={{ position: "absolute", top: "30px", left: "130px", fontSize:"30px"}}><b>45</b></p>
                </div>
                <div className='companions_lower'>
                    ...
                    style={{
                        ...
                        <p style={{position:"absolute", left:"60px", top:"30px"}}><b>Helly Shah</b></p>
                    </div>
                    ...
                    style={{
                        ...
                        <p style={{position:"absolute", left:"60px", top:"30px"}}><b>Dave Smith</b></p>
                    </div>
                    ...
                    style={{
                        ...
                        <p style={{position:"absolute", left:"60px", top:"30px"}}><b>Samantha</b></p>
                    </div>
                </div>
