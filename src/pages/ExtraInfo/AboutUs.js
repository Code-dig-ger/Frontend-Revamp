        ...
        <div className='container'>
            ...
            <Row gutter={[8, 24]} className='AboutUsContentWrapper' >
                ...
                <Col sm={12} md={12} xs={24} >
                    <p className="contentHeadLine" style={{ fontSize: '1.8em', color: 'white' }}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, pariatur!</p>
            ...
            <Row>
                <Col span={24}>
                    <div className="faqsWrapper" >
                        <div id="qAns1" className="qAns" onClick={(e) => setToggleQ1(!toggleQ1)}>
                            <div className="q" >
                                <p style={{ background: "rgba(44, 44, 44, 1)" }}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam et sint illum inventore deleniti magnam maxime quae unde, tenetur fugiat, ratione vero placeat est officia atque earum cupiditate provident quis.</p>
                                {toggleQ1 && (
                                    <div className="answer">
                                        <p className="ans">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorum necessitatibus corrupti quod quisquam.</p>
                                    </div>
                                )}
                            </div>
                            <CaretDownOutlined className="dragdown" />
                        </div>
                        <div id="qAns2" className="qAns" onClick={(e) => setToggleQ2(!toggleQ2)}>
                            <div className="q" >
                                <p style={{ background: "rgba(44, 44, 44, 1)" }}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere, itaque?</p>
                                {toggleQ2 && (
                                    <div className="answer">
                                        <p className="ans">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorum necessitatibus corrupti quod quisquam.</p>
                                    </div>
                                )}
                            </div> <CaretDownOutlined className="dragdown" />
                        </div>
                        <div id="qAns3" className="qAns" onClick={(e) => setToggleQ3(!toggleQ3)}>
                            <div className="q" >
                                <p style={{ background: "rgba(44, 44, 44, 1)" }}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere, itaque?</p>
                                {toggleQ3 && (
                                    <div className="answer">
                        ...
                        <div id="qAns4" className="qAns" onClick={(e) => setToggleQ4(!toggleQ4)}>
                            <div className="q" >
                                <p style={{ background: "rgba(44, 44, 44, 1)" }}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere, itaque?</p>
                                {toggleQ4 && (
                                    <div className="answer">
                        ...
                        <div id="qAns5" className="qAns" onClick={(e) => setToggleQ5(!toggleQ5)}>
                            <div className="q" >
                                <p style={{ background: "rgba(44, 44, 44, 1)" }}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere, itaque?</p>
                                {toggleQ5 && (
                                    <div className="answer">
